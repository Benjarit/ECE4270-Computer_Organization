...
void rdump() {                               
	...
	printf("PC\t: 0x%08x\n", CURRENT_STATE.PC);void handle_instruction()
{
	/*IMPLEMENT THIS*/
...
void handle_instruction()
{
	...
	switch(opc){
		case 0x00000020: //ADD
			printf("This is add");
			reg1 = instruction & 0x03E00000;
			reg2 = instruction & 0x001F0000;
			reg3 = instruction & 0x0000F800;
			CURRENT_STATE.REGS[reg3] = CURRENT_STATE.REGS[reg1] + CURRENT_STATE.REGS[reg2];
			CURRENT_STATE.PC += 0x00000004;
			break;
